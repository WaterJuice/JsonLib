...
// Base64 of a 768-byte pattern: each byte value 0..255 repeated three times in order.
static char const* const gBase64_TripledBytes =
...
// Base64 of a 256-byte pattern: byte values 0..255 in order.
static char const* const gBase64_AllBytes =
    ...
    )
{
    ...
    JL_ASSERT_NOT_NULL( string );
    JL_ASSERT( strcmp( string, gBase64_TripledBytes ) == 0 );
    ...
    JL_ASSERT_NOT_NULL( string );
    JL_ASSERT( strcmp( string, gBase64_AllBytes ) == 0 );
    ...
    )
{
    ...
    JL_ASSERT_SUCCESS( JlBase64Decode( gBase64_TripledBytes, (void**)&data, &dataSize ) );
    JL_ASSERT_NOT_NULL( data );
    ...
    JL_ASSERT_SUCCESS( JlBase64Decode( gBase64_AllBytes, (void**)&data, &dataSize ) );
    JL_ASSERT_NOT_NULL( data );
